 ...
 * Use the {@link LichCho_Fragment#newInstance} factory method to
...
public class LichCho_Fragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    public static LichCho_Fragment newInstance() {
        LichCho_Fragment fragment = new LichCho_Fragment();

        return fragment;
    }

    public LichCho_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_lich_cho_, container, false);
    }
